...
def help(bot, trigger):
    ...
    if not trigger.group(2):
        bot.reply('Say !help <command> (for example !help help) to get help for a command, or !commands for a list of commands.')
    else:
...
def commands(bot, trigger):
    ...
    bot.say('Commands I recognise: ' + names + '.', max_messages=10)
