...
class Willie(irc.Bot):
    ...
    def __init__(self, config):
        ...
        self.tmp = 0
        print("Setting first media...")
        self.media = self.vlc_instance.media_new("Matches\\" + self.matches_tab[self.tmp])
        self.player = self.vlc_instance.media_player_new()
        self.player.set_media(self.media)
        self.player.set_fullscreen(True)
        self.player.audio_output_device_set(None, '{8AD6ACE6-7AA0-421F-B6B8-F78758B3408D}')
        self.voteskip = 0
        self.voters = []
        self.rates_tab = {}
